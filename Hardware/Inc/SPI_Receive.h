...
extern void W25Q128_ReadID(uint8_t *MID,uint16_t *DID);
extern void W25Q128_WriteEnable(void);
extern void W25Q128_WaitBusy(void);
extern void W25Q128_PageProgram(uint32_t Address,uint8_t*DataArray,uint16_t Count);
