...
{
    uint16_t chassis_volt;//电源管理模块的chassis口输出电压
    uint16_t chassis_current;//电源管理模块的chassis口输出电压
    float chassis_power;
...
extern void get_chassis_power_and_buffer_and_power_limit(float *power, uint16_t *buffer, uint16_t *power_limit, uint16_t *chassis_volt);

extern uint8_t get_robot_id(void);

extern void get_shoot_heat0_limit_and_heat0(uint16_t *heat0_limit, uint16_t *heat0);
extern void get_shoot_heat1_limit_and_heat1(uint16_t *heat1_limit, uint16_t *heat1);
extern void get_shoot_speed(float *speed);
