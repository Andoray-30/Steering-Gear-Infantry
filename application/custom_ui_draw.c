...
#define AIM_CENTER_X 967
#define AIM_CENTER_Y 505
...
#define VISUAL_BORDOR_START_X (CENTER_X - 700)
#define VISUAL_BORDOR_START_Y (CENTER_Y - 520)
#define VISUAL_BORDOR_END_X (CENTER_X + 50)
#define VISUAL_BORDOR_END_Y (CENTER_Y + 40)
#define AUTO_X 250
#define AUTO_Y 250
...
void test_7_graphic(uint16_t sender_id, uint16_t receiver_id)
{
    ...
    test_draw.grapic_data_struct[0].operate_tpye = 1;//1 增加图形操作
    test_draw.grapic_data_struct[0].graphic_tpye = 0;//直线
    test_draw.grapic_data_struct[0].layer = 0;//图层数
  ...
  //上面三个字节代表的是图形名，用于图形索引，可自行定义
    ...
    //上面三个字节代表的是图形名，用于图形索引，可自行定义
    test_draw.grapic_data_struct[4].operate_tpye = 1; //???é???????§??ˇé????¤??ˇé????¤??ˇ0é????¤??ˇé???§???§??ˇé????¤??ˇé????¤??ˇ1é????¤??ˇé????¤??ˇé??????????ˇ2é????¤??ˇé?????é????ˇ
    test_draw.grapic_data_struct[4].graphic_tpye = 0; //???é????¤??ˇé????¤??ˇé??é????????0??????é??????????ˇé????¤??ˇé????¤??ˇé???????????é??????????ˇé???????§??ˇ
    test_draw.grapic_data_struct[4].layer = 0;        //???é????¤??ˇé????¤???
    test_draw.grapic_data_struct[4].color = 8;        //é????¤??ˇ???
    ...
    test_draw.grapic_data_struct[5].graphic_name[2] = 0; //???é????¤??ˇé????¤???
    //é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé?????????????ˇé????¤??ˇé????¤??ˇé????¤??ˇ???é????¤???6é????¤???5é????¤??ˇ???é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé??????????ˇé????¤???
    test_draw.grapic_data_struct[5].operate_tpye = 0; //???é???????§??ˇé????¤??ˇé????¤??ˇ0é????¤??ˇé???§???§??ˇé????¤??ˇé????¤??ˇ1é????¤??ˇé????¤??ˇé??????????ˇ2é????¤??ˇé?????é????ˇ
    test_draw.grapic_data_struct[5].graphic_tpye = 0; //???é????¤??ˇé????¤??ˇé??é????????0??????é??????????ˇé????¤??ˇé????¤??ˇé???????????é??????????ˇé???????§??ˇ
    test_draw.grapic_data_struct[5].layer = 0;        //???é????¤??ˇé????¤???
    test_draw.grapic_data_struct[5].color = 8;        //é????¤??ˇ???
    ...
    test_draw.grapic_data_struct[6].graphic_name[2] = 0; //???é????¤??ˇé????¤???
    //é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé?????????????ˇé????¤??ˇé????¤??ˇé????¤??ˇ???é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇ???é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé??????????ˇé????¤???
    test_draw.grapic_data_struct[6].operate_tpye = 0; //???é???????§??ˇé????¤??ˇé????¤??ˇ0é????¤??ˇé???§???§??ˇé????¤??ˇé????¤??ˇ1é????¤??ˇé????¤??ˇé??????????ˇ2é????¤??ˇé?????é????ˇ
    test_draw.grapic_data_struct[6].graphic_tpye = 4; //???é????¤??ˇé????¤??ˇé??é????????0??????é??????????ˇé????¤??ˇé????¤??ˇé???????????é??????????ˇé???????§??ˇ
    test_draw.grapic_data_struct[6].layer = 0;        //???é????¤??ˇé????¤???
    test_draw.grapic_data_struct[6].color = 8;        //é????¤??ˇ???
...
void Send_Speed(uint16_t sender_id, uint16_t receiver_id)
{
    ...
    draw_init.grapic_data_struct.start_angle = 15; //é???????¤??ˇé????¤??ˇ?°?
    draw_init.grapic_data_struct.end_angle = 6;    //é???????¤??ˇé????¤??ˇé????¤???
...
void draw_init_all(uint16_t sender_id, uint16_t receiver_id)
{
    ...
    osDelay(100);
    draw_aim_assitant2(sender_id, receiver_id, 1, 1);//画中间准心线
    osDelay(100);
    draw_chassis_mode(sender_id, receiver_id, 1);//画“chassis_mode”
    osDelay(100);
    draw_chassis_mode_state(sender_id, receiver_id, 1);//画具体底盘模式
    osDelay(100);
    draw_chassis_run_bordor(sender_id, receiver_id, 1);//画底盘前进的边界线
    osDelay(100);
    ...
    osDelay(100);
		draw_shoot(sender_id, receiver_id, 1);
    osDelay(100);
		draw_shoot_circle(sender_id, receiver_id, 1);
    osDelay(100);
    draw_capacity_tangle(sender_id, receive_id, 1);
    osDelay(100);
		draw_auto_circle(sender_id, receive_id, 1);
    osDelay(100);
...
void draw_chassis_mode_state(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    case CHASSIS_NO_MOVE:
        draw_init.grapic_data_struct.color = 3;
        draw_init.grapic_data_struct.end_angle = 8; //?????????????????????
        draw_init.data[0] = 'N';
        draw_init.data[1] = 'O';
        draw_init.data[2] = '_';
        draw_init.data[3] = 'M';
    ...
    case CHASSIS_FOLLOW_GIMBAL:
        draw_init.grapic_data_struct.color = 3;
        draw_init.grapic_data_struct.end_angle = 6; //?????????????????????
        draw_init.data[0] = 'F';
        draw_init.data[1] = 'O';
        draw_init.data[2] = 'L';
        draw_init.data[3] = 'L';
    ...
    case CHASSIS_TOP:
        draw_init.grapic_data_struct.color = 3;
        draw_init.grapic_data_struct.end_angle = 3; //?????????????????????
        draw_init.data[0] = 'T';
        draw_init.data[1] = 'O';
        draw_init.data[2] = 'P';
        break;
    ...
    case CHASSIS_OPEN:
        draw_init.grapic_data_struct.color = 3;
        draw_init.grapic_data_struct.end_angle = 5; //?????????????????????
        draw_init.data[0] = 'O';
        draw_init.data[1] = 'P';
        draw_init.data[2] = 'E';
        draw_init.data[3] = 'N';
...
void draw_aim_assitant1(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type, uint16_t layer)
{
    ...
    test_draw.grapic_data_struct[1].graphic_name[2] = 11; //???é????¤??ˇé????¤???
    //é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé?????????????ˇé????¤??ˇé????¤??ˇé????¤??ˇ???é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇ???é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé??????????ˇé????¤???
    test_draw.grapic_data_struct[1].operate_tpye = op_type; //???é???????§??ˇé????¤??ˇé????¤??ˇ0é????¤??ˇé???§???§??ˇé????¤??ˇé????¤??ˇ1é????¤??ˇé????¤??ˇé??????????ˇ2é????¤??ˇé??????????????3é????¤??ˇ???é????¤??ˇé????¤??ˇ
    test_draw.grapic_data_struct[1].graphic_tpye = 0;       //???é????¤??ˇé????¤??ˇé??é????????0??????é??????????ˇé????¤??ˇé????¤??ˇé???????????é??????????ˇé???????§??ˇ
    test_draw.grapic_data_struct[1].layer = layer;          //???é????¤??ˇé????¤???
    test_draw.grapic_data_struct[1].color = 1;              //é????¤??ˇ???
    test_draw.grapic_data_struct[1].start_angle = 0;
    test_draw.grapic_data_struct[1].end_angle = 0;
    ...
    test_draw.grapic_data_struct[2].graphic_name[2] = 12; //???é????¤??ˇé????¤???
    //é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé?????????????ˇé????¤??ˇé????¤??ˇé????¤??ˇ???é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇ???é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé??????????ˇé????¤???
    test_draw.grapic_data_struct[2].operate_tpye = op_type; //???é???????§??ˇé????¤??ˇé????¤??ˇ0é????¤??ˇé???§???§??ˇé????¤??ˇé????¤??ˇ1é????¤??ˇé????¤??ˇé??????????ˇ2é????¤??ˇé?????é????ˇ
    test_draw.grapic_data_struct[2].graphic_tpye = 0;       //???é????¤??ˇé????¤??ˇé??é????????0??????é??????????ˇé????¤??ˇé????¤??ˇé???????????é??????????ˇé???????§??ˇ
    test_draw.grapic_data_struct[2].layer = layer;          //???é????¤??ˇé????¤???
    test_draw.grapic_data_struct[2].color = 2;              //é????¤??ˇ???
    test_draw.grapic_data_struct[2].start_angle = 0;
    test_draw.grapic_data_struct[2].end_angle = 0;
    ...
    test_draw.grapic_data_struct[3].graphic_name[2] = 13; //???é????¤??ˇé????¤???
    //é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé?????????????ˇé????¤??ˇé????¤??ˇé????¤??ˇ???é????¤??ˇé????¤??ˇé????¤??ˇ???é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé??????????ˇé????¤???
    test_draw.grapic_data_struct[3].operate_tpye = op_type; //???é???????§??ˇé????¤??ˇé????¤??ˇ0é????¤??ˇé???§???§??ˇé????¤??ˇé????¤??ˇ1é????¤??ˇé????¤??ˇé??????????ˇ2é????¤??ˇé?????é????ˇ
    test_draw.grapic_data_struct[3].graphic_tpye = 0;       //???é????¤??ˇé????¤??ˇé??é????????0??????é??????????ˇé????¤??ˇé????¤??ˇé???????????é??????????ˇé???????§??ˇ
    test_draw.grapic_data_struct[3].layer = layer;          //???é????¤??ˇé????¤???
    test_draw.grapic_data_struct[3].color = 3;              //é????¤??ˇ???
    test_draw.grapic_data_struct[3].start_angle = 0;
    test_draw.grapic_data_struct[3].end_angle = 0;
    ...
    test_draw.grapic_data_struct[4].graphic_name[2] = 14; //???é????¤??ˇé????¤???
    //é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé?????????????ˇé????¤??ˇé????¤??ˇé????¤??ˇ???é????¤??ˇé????¤??ˇ4é????¤??ˇ???é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé??????????ˇé????¤???
    test_draw.grapic_data_struct[4].operate_tpye = op_type; //???é???????§??ˇé????¤??ˇé????¤??ˇ0é????¤??ˇé???§???§??ˇé????¤??ˇé????¤??ˇ1é????¤??ˇé????¤??ˇé??????????ˇ2é????¤??ˇé?????é????ˇ
    test_draw.grapic_data_struct[4].graphic_tpye = 0;       //???é????¤??ˇé????¤??ˇé??é????????0??????é??????????ˇé????¤??ˇé????¤??ˇé???????????é??????????ˇé???????§??ˇ
    test_draw.grapic_data_struct[4].layer = layer;          //???é????¤??ˇé????¤???
    test_draw.grapic_data_struct[4].color = 4;              //é????¤??ˇ???
    test_draw.grapic_data_struct[4].start_angle = 0;
    test_draw.grapic_data_struct[4].end_angle = 0;
    ...
    test_draw.grapic_data_struct[5].graphic_name[2] = 15; //???é????¤??ˇé????¤???
    //é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé?????????????ˇé????¤??ˇé????¤??ˇé????¤??ˇ???é????¤???6é????¤???5é????¤??ˇ???é????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé????¤??ˇé??????????ˇé????¤???
    test_draw.grapic_data_struct[5].operate_tpye = op_type; //???é???????§??ˇé????¤??ˇé????¤??ˇ0é????¤??ˇé???§???§??ˇé????¤??ˇé????¤??ˇ1é????¤??ˇé????¤??ˇé??????????ˇ2é????¤??ˇé?????é????ˇ
    test_draw.grapic_data_struct[5].graphic_tpye = 0;       //???é????¤??ˇé????¤??ˇé??é????????0??????é??????????ˇé????¤??ˇé????¤??ˇé???????????é??????????ˇé???????§??ˇ
    test_draw.grapic_data_struct[5].layer = layer;          //???é????¤??ˇé????¤???
    test_draw.grapic_data_struct[5].color = 5;              //é????¤??ˇ???
    test_draw.grapic_data_struct[5].start_angle = 0;
    test_draw.grapic_data_struct[5].end_angle = 0;
    ...
    test_draw.grapic_data_struct[6].graphic_name[2] = 16; //???é????¤??ˇé????¤???

    test_draw.grapic_data_struct[6].operate_tpye = op_type; //???é???????§??ˇé????¤??ˇé????¤??ˇ0é????¤??ˇé???§???§??ˇé????¤??ˇé????¤??ˇ1é????¤??ˇé????¤??ˇé??????????ˇ2é????¤??ˇé?????é????ˇ
    test_draw.grapic_data_struct[6].graphic_tpye = 0;       //???é????¤??ˇé????¤??ˇé??é????????0??????é??????????ˇé????¤??ˇé????¤??ˇé???????????é??????????ˇé???????§??ˇ
    test_draw.grapic_data_struct[6].layer = layer;          //???é????¤??ˇé????¤???
    test_draw.grapic_data_struct[6].color = 6;              //é????¤??ˇ???
...
void draw_chassis_run_bordor(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    draw_init.grapic_data_struct[0].layer = 3;//图层数（3）
    draw_init.grapic_data_struct[0].color = 3;//橙色
    draw_init.grapic_data_struct[0].width = 3;//线宽（3）
    draw_init.grapic_data_struct[0].start_x = AIM_CENTER_X - CHASSIS_RUN_BORDER_START_X;
    draw_init.grapic_data_struct[0].start_y = CHASSIS_RUN_BORDER_START_Y;
    draw_init.grapic_data_struct[0].end_x = AIM_CENTER_X - CHASSIS_RUN_BORDER_END_X;
    ...
    draw_init.grapic_data_struct[1].graphic_name[2] = 20; //图形名
    draw_init.grapic_data_struct[1].operate_tpye = op_type; //图形操作，1：增加
    draw_init.grapic_data_struct[1].graphic_tpye = 0;       //图形类型，0为直线，其他的查看用户手册
    draw_init.grapic_data_struct[1].layer = 3;              //图层数（3）
    draw_init.grapic_data_struct[1].color = 3;              //橙色
    draw_init.grapic_data_struct[1].width = 3;				//线宽（3）
    draw_init.grapic_data_struct[1].start_x = AIM_CENTER_X + CHASSIS_RUN_BORDER_START_X;
    draw_init.grapic_data_struct[1].start_y = CHASSIS_RUN_BORDER_START_Y;
    draw_init.grapic_data_struct[1].end_x = AIM_CENTER_X + CHASSIS_RUN_BORDER_END_X;
    ...
    draw_init.grapic_data_struct[2].graphic_name[2] = 17; //图形名
    draw_init.grapic_data_struct[2].operate_tpye = op_type; //图形操作，1：增加
    draw_init.grapic_data_struct[2].graphic_tpye = 0;       //图形类型，0为直线，其他的查看用户手册
    draw_init.grapic_data_struct[2].layer = 3;              //图层数（3）
    draw_init.grapic_data_struct[2].color = 3;              //橙色
    draw_init.grapic_data_struct[2].width = 3;              //线宽（3）
    draw_init.grapic_data_struct[2].start_x = AIM_CENTER_X - CHASSIS_RUN_BORDER_END_X;//520，260
    draw_init.grapic_data_struct[2].start_y = CHASSIS_RUN_BORDER_END_Y;
    draw_init.grapic_data_struct[2].end_x = AIM_CENTER_X - CHASSIS_RUN_BORDER_END_X + 100;//620，260
    ...
    draw_init.grapic_data_struct[3].graphic_name[2] = 1; //图形名
	//上面三个字节代表的是图形名，用于图形索引，可自行定义
    draw_init.grapic_data_struct[3].operate_tpye = op_type; //图形操作，1：增加
    draw_init.grapic_data_struct[3].graphic_tpye = 0;       //图形类型，0为直线，其他的查看用户手册
    draw_init.grapic_data_struct[3].layer = 3;              //图层数（3）
    draw_init.grapic_data_struct[3].color = 3;              //橙色
    draw_init.grapic_data_struct[3].width = 3;              //线宽（3）
    draw_init.grapic_data_struct[3].start_x = AIM_CENTER_X + CHASSIS_RUN_BORDER_END_X;//1400，260
    draw_init.grapic_data_struct[3].start_y = CHASSIS_RUN_BORDER_END_Y;
    draw_init.grapic_data_struct[3].end_x = AIM_CENTER_X + CHASSIS_RUN_BORDER_END_X - 100;//1300，260
...
{
    tank->r = VERTICAL * 1.3;
    tank->angle = -(gimbal_control.gimbal_yaw_motor.relative_angle) - PI/13.0f;
...
void draw_aim_assitant2(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type, uint16_t layer)
{
    ...
    test_draw.header_data_t.data_cmd_id = 0x0104;//客户端绘制七个图形
    test_draw.header_data_t.sender_ID = sender_id;
    test_draw.header_data_t.receiver_ID = receiver_id;
    ...
    test_draw.grapic_data_struct[0].operate_tpye = op_type;//图形操作  1：增加
    test_draw.grapic_data_struct[0].graphic_tpye = 0;//直线
    test_draw.grapic_data_struct[0].layer = layer;//图层数（1）
    test_draw.grapic_data_struct[0].color = 3;//橙色
    test_draw.grapic_data_struct[0].width = WIDTH;//线宽（1）
    ...
    //上面三个字节代表的是图形名，用于图形索引，可自行定义
    test_draw.grapic_data_struct[1].operate_tpye = op_type; //图形操作，1：增加
    test_draw.grapic_data_struct[1].graphic_tpye = 0;       //图形类型，0为直线，其他的查看用户手册
    test_draw.grapic_data_struct[1].layer = layer;          //图层数（1）
    test_draw.grapic_data_struct[1].color = 3;              
    test_draw.grapic_data_struct[1].width = 3;				//线宽（1）
		test_draw.grapic_data_struct[1].start_x = AIM_CENTER_X + 40;//905+40，285
    test_draw.grapic_data_struct[1].start_y = AIM_CENTER_Y;
    test_draw.grapic_data_struct[1].end_x = AIM_CENTER_X - 40;//935+40，285
    test_draw.grapic_data_struct[1].end_y = AIM_CENTER_Y;//横线长30
    test_draw.grapic_data_struct[1].radius = 0;
    ...
    //上面三个字节代表的是图形名，用于图形索引，可自行定义
    test_draw.grapic_data_struct[2].operate_tpye = op_type; //图形操作，1：增加；
    test_draw.grapic_data_struct[2].graphic_tpye = 0;       //图形类型，0为直线，其他的查看用户手册
    test_draw.grapic_data_struct[2].layer = layer;          //图层数（1）
    test_draw.grapic_data_struct[2].color = 8;            
    test_draw.grapic_data_struct[2].width = WIDTH;			//线宽（1）
    test_draw.grapic_data_struct[2].start_x = AIM_CENTER_X - AIM_HORIAZONTAL_SHORT_X;
    test_draw.grapic_data_struct[2].start_y = AIM_CENTER_Y - AIM_VERTICAL_SHORT_Y;
    test_draw.grapic_data_struct[2].end_x = AIM_CENTER_X + AIM_HORIAZONTAL_SHORT_X ;
    test_draw.grapic_data_struct[2].end_y = AIM_CENTER_Y - AIM_VERTICAL_SHORT_Y;
    test_draw.grapic_data_struct[2].radius = 0;
    ...
    //上面三个字节代表的是图形名，用于图形索引，可自行定义
    test_draw.grapic_data_struct[3].operate_tpye = op_type; //图形操作，1：增加；
    test_draw.grapic_data_struct[3].graphic_tpye = 0;       //图形类型，0为直线，其他的查看用户手册
    test_draw.grapic_data_struct[3].layer = layer;          //图层数（1）
    test_draw.grapic_data_struct[3].color = 8;            
    test_draw.grapic_data_struct[3].width = WIDTH;			//线宽（1）
    test_draw.grapic_data_struct[3].start_x = AIM_CENTER_X - AIM_HORIAZONTAL_SHORT_X;
    test_draw.grapic_data_struct[3].start_y = AIM_CENTER_Y - 2 * AIM_VERTICAL_SHORT_Y;
    test_draw.grapic_data_struct[3].end_x = AIM_CENTER_X + AIM_HORIAZONTAL_SHORT_X ;
    test_draw.grapic_data_struct[3].end_y = AIM_CENTER_Y - 2 * AIM_VERTICAL_SHORT_Y;
    test_draw.grapic_data_struct[3].radius = 0;
    ...
    //上面三个字节代表的是图形名，用于图形索引，可自行定义
    test_draw.grapic_data_struct[4].operate_tpye = op_type; //图形操作，1：增加；
    test_draw.grapic_data_struct[4].graphic_tpye = 0;       //图形类型，0为直线，其他的查看用户手册
    test_draw.grapic_data_struct[4].layer = layer;          //图层数（1）
    test_draw.grapic_data_struct[4].color = 8;            
    test_draw.grapic_data_struct[4].width = WIDTH;			//线宽（1）
    test_draw.grapic_data_struct[4].start_x = AIM_CENTER_X - AIM_HORIAZONTAL_SHORT_X;
    test_draw.grapic_data_struct[4].start_y = AIM_CENTER_Y - 3 * AIM_VERTICAL_SHORT_Y;
    test_draw.grapic_data_struct[4].end_x = AIM_CENTER_X + AIM_HORIAZONTAL_SHORT_X ;
    test_draw.grapic_data_struct[4].end_y = AIM_CENTER_Y - 3 * AIM_VERTICAL_SHORT_Y;
    test_draw.grapic_data_struct[4].radius = 0;
    ...
    //上面三个字节代表的是图形名，用于图形索引，可自行定义
    test_draw.grapic_data_struct[5].operate_tpye = op_type; //图形操作，1：增加；
    test_draw.grapic_data_struct[5].graphic_tpye = 0;       //图形类型，0为直线，其他的查看用户手册
    test_draw.grapic_data_struct[5].layer = layer;          //图层数（1）
    test_draw.grapic_data_struct[5].color = 8;            
    test_draw.grapic_data_struct[5].width = WIDTH;			//线宽（1）
    test_draw.grapic_data_struct[5].start_x = AIM_CENTER_X - AIM_HORIAZONTAL_SHORT_X;
    test_draw.grapic_data_struct[5].start_y = AIM_CENTER_Y - 4 * AIM_VERTICAL_SHORT_Y;
    test_draw.grapic_data_struct[5].end_x = AIM_CENTER_X + AIM_HORIAZONTAL_SHORT_X ;
    test_draw.grapic_data_struct[5].end_y = AIM_CENTER_Y - 4 * AIM_VERTICAL_SHORT_Y;
    test_draw.grapic_data_struct[5].radius = 0;
    ...
    //上面三个字节代表的是图形名，用于图形索引，可自行定义
    test_draw.grapic_data_struct[6].operate_tpye = op_type; //图形操作，1：增加；
    test_draw.grapic_data_struct[6].graphic_tpye = 0;       //图形类型，0为直线，其他的查看用户手册
    test_draw.grapic_data_struct[6].layer = layer;          //图层数（1）
    test_draw.grapic_data_struct[6].color = 8;            
    test_draw.grapic_data_struct[6].width = WIDTH;			//线宽（1）
    test_draw.grapic_data_struct[6].start_x = AIM_CENTER_X - AIM_HORIAZONTAL_SHORT_X;
    test_draw.grapic_data_struct[6].start_y = AIM_CENTER_Y - 5 * AIM_VERTICAL_SHORT_Y;
    test_draw.grapic_data_struct[6].end_x = AIM_CENTER_X + AIM_HORIAZONTAL_SHORT_X ;
    test_draw.grapic_data_struct[6].end_y = AIM_CENTER_Y - 5 * AIM_VERTICAL_SHORT_Y;
    test_draw.grapic_data_struct[6].radius = 0;
...
//小陀螺标识
void draw_state_of_top(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ext_client_custom_character_t draw_init;
    draw_init.header_data_t.data_cmd_id = 0x0110;
    draw_init.header_data_t.sender_ID = sender_id;
    ...
    draw_init.grapic_data_struct.graphic_tpye = 7;
    draw_init.grapic_data_struct.layer = 2;
    draw_init.grapic_data_struct.color = 5;
    draw_init.grapic_data_struct.start_angle = FONT_SIZE; 

    draw_init.grapic_data_struct.width = 2;
    draw_init.grapic_data_struct.start_x = AIM_CENTER_X - CHASSIS_RUN_BORDER_END_X + 26;
    draw_init.grapic_data_struct.start_y = CHASSIS_RUN_BORDER_END_Y - 43;
    draw_init.grapic_data_struct.end_x = 0;
    draw_init.grapic_data_struct.end_y = 0;
    draw_init.grapic_data_struct.radius = 0;
...
void draw_state_of_top_circle(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    draw_init.grapic_data_struct.layer = 1;
    draw_init.grapic_data_struct.start_x = AIM_CENTER_X - CHASSIS_RUN_BORDER_END_X + 30;
    draw_init.grapic_data_struct.start_y = CHASSIS_RUN_BORDER_END_Y - 50;
...
void draw_shoot_circle(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    draw_init.grapic_data_struct.graphic_name[0] = 0;
    draw_init.grapic_data_struct.graphic_name[1] = 0;
    draw_init.grapic_data_struct.graphic_name[2] = 55;
    draw_init.grapic_data_struct.operate_tpye = op_type;
    draw_init.grapic_data_struct.graphic_tpye = 2;
    draw_init.grapic_data_struct.layer = 1;
    draw_init.grapic_data_struct.start_x = AIM_CENTER_X + CHASSIS_RUN_BORDER_END_X - 30;
...
//摩擦轮标识
void draw_shoot(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ext_client_custom_character_t draw_init;
    draw_init.header_data_t.data_cmd_id = 0x0110;
    draw_init.header_data_t.sender_ID = sender_id;
    ...
    draw_init.grapic_data_struct.graphic_name[0] = 0;
    draw_init.grapic_data_struct.graphic_name[1] = 0;
    draw_init.grapic_data_struct.graphic_name[2] = 56;
    draw_init.grapic_data_struct.operate_tpye = op_type;
    draw_init.grapic_data_struct.graphic_tpye = 7;
    draw_init.grapic_data_struct.layer = 2;
    draw_init.grapic_data_struct.color = 5;
    ...
    draw_init.grapic_data_struct.width = 2;
    draw_init.grapic_data_struct.start_x = AIM_CENTER_X + CHASSIS_RUN_BORDER_END_X - 34;
    draw_init.grapic_data_struct.start_y = CHASSIS_RUN_BORDER_END_Y - 43;
    draw_init.grapic_data_struct.end_x = 0;
    draw_init.grapic_data_struct.end_y = 0;
    draw_init.grapic_data_struct.radius = 0;
...
//自瞄显示
void draw_auto_circle(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ext_client_custom_graphic_single_t draw_init;
    draw_init.header_data_t.data_cmd_id = 0x0101;
    draw_init.header_data_t.sender_ID = sender_id;
    ...
    draw_init.grapic_data_struct.graphic_name[0] = 0;
    draw_init.grapic_data_struct.graphic_name[1] = 0;
    draw_init.grapic_data_struct.graphic_name[2] = 57;
    draw_init.grapic_data_struct.operate_tpye = op_type;
    draw_init.grapic_data_struct.graphic_tpye = 1;
    draw_init.grapic_data_struct.layer = 1;
    draw_init.grapic_data_struct.start_x = AIM_CENTER_X - AUTO_X;
    draw_init.grapic_data_struct.start_y = AIM_CENTER_Y + AUTO_Y;
		draw_init.grapic_data_struct.end_x = AIM_CENTER_X + AUTO_X;
    draw_init.grapic_data_struct.end_y = AIM_CENTER_Y - AUTO_Y;
    draw_init.grapic_data_struct.width = 5;
...
void audio_enemy_godlike(uint16_t sender_id, uint16_t receiver_id)
{
    ...
    draw_init.grapic_data_struct.layer = 2;
    draw_init.grapic_data_struct.color = 8;
    draw_init.grapic_data_struct.start_angle = FONT_SIZE; //é???????¤??ˇé????¤??ˇ?°?
    ...
    memset(draw_init.data, 0, sizeof(draw_init.data));
    draw_init.grapic_data_struct.end_angle = 22; //é???????¤??ˇé????¤??ˇé????¤???
    draw_init.data[0] = 'E';
    draw_init.data[1] = 'N';
    draw_init.data[2] = 'E';
    draw_init.data[3] = 'M';
...
{
    super_capacity->power_ratio = (Super_Power_Data.v_out - 10.0f) / 14.5f;
    super_capacity->jindu = (uint16_t)(super_capacity->power_ratio * 298);
...
void draw_auto(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
   ext_client_custom_character_t draw_init;
    draw_init.header_data_t.data_cmd_id = 0x0110;
    draw_init.header_data_t.sender_ID = sender_id;
    ...
    draw_init.grapic_data_struct.end_angle = 5; //é??????????????é?ˇ??????é????????é????????é?ˇ???
    draw_init.data[0] = 'A';
    draw_init.data[1] = 'U';
    draw_init.data[2] = 'T';
    draw_init.data[3] = 'O';
...
void draw_pitch(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    draw_init.grapic_data_struct.operate_tpye = op_type;
    draw_init.grapic_data_struct.graphic_tpye = 7;
    draw_init.grapic_data_struct.layer = 2;//é????§??°é????????é?????
    draw_init.grapic_data_struct.color = 8;
    draw_init.grapic_data_struct.start_angle = FONT_SIZE; 
    ...
    draw_init.grapic_data_struct.end_angle = 6; //é??????????????é?ˇ??????é????????é????????é?ˇ???
    draw_init.data[0] = 'P';
    draw_init.data[1] = 'I';
    draw_init.data[2] = 'T';
    draw_init.data[3] = 'C';
...
void draw_speed_cut(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    draw_init.grapic_data_struct.end_angle = 8; //é??????????????é?ˇ??????é????????é????????é?ˇ???
    draw_init.data[0] = 'S';
    draw_init.data[1] = 'P';
    draw_init.data[2] = 'D';
    draw_init.data[3] = ' ';
...
void draw_visual_bordor(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ext_client_custom_character_t draw_init;
    ...
    draw_init.grapic_data_struct.color = 8;
    draw_init.grapic_data_struct.width = 1;
    draw_init.grapic_data_struct.start_x = VISUAL_BORDOR_START_X;
    draw_init.grapic_data_struct.start_y = VISUAL_BORDOR_START_Y;
    draw_init.grapic_data_struct.end_x = VISUAL_BORDOR_END_X;
    draw_init.grapic_data_struct.end_y = VISUAL_BORDOR_END_Y;
...
void draw_top_speed(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    if (n == 0)
    {
        draw_init.grapic_data_struct.end_angle = 3; //é???????¤??ˇé????¤??ˇé????¤???
        draw_init.data[0] = 'L';
        draw_init.data[1] = 'O';
        draw_init.data[2] = 'W';
    }
    ...
    {
        draw_init.grapic_data_struct.end_angle = 4; //é???????¤??ˇé????¤??ˇé????¤???
        draw_init.data[0] = 'H';
        draw_init.data[1] = 'I';
        draw_init.data[2] = 'G';
        draw_init.data[3] = 'H';
