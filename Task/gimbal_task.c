...
void gimbal_task(void const *pvParameters)
{
  ...
  while (1)
  {
    ...
    {
      //改变yaw电机pid
      gimbal_PID_init(&gimbal_control.gimbal_yaw_motor.gimbal_motor_absolute_angle_pid, YAW_ABSOLUTE_ANGLE_TOP_KP, YAW_ABSOLUTE_ANGLE_TOP_KI, YAW_ABSOLUTE_ANGLE_TOP_KD, YAW_ABSOLUTE_ANGLE_MAX_OUT, YAW_ABSOLUTE_ANGLE_MAX_IOUT); //锟斤拷锟斤拷锟角角度匡拷锟斤拷
    ...
    {
      gimbal_PID_init(&gimbal_control.gimbal_yaw_motor.gimbal_motor_absolute_angle_pid, YAW_ABSOLUTE_ANGLE_KP, YAW_ABSOLUTE_ANGLE_KI, YAW_ABSOLUTE_ANGLE_KD, YAW_ABSOLUTE_ANGLE_MAX_OUT, YAW_ABSOLUTE_ANGLE_MAX_IOUT); //锟斤拷锟斤拷锟角角度匡拷锟斤拷
      PID_init(&gimbal_control.gimbal_yaw_motor.gimbal_motor_gyro_pid, YAW_GYRO_KP, YAW_GYRO_KI, YAW_GYRO_KD, YAW_GYRO_MAX_OUT, YAW_GYRO_MAX_IOUT);
    }

    if (gimbal_behaviour == GIMBAL_AUTO && last_gimbal_behaviour != gimbal_behaviour )
    {
      gimbal_PID_init(&gimbal_control.gimbal_yaw_motor.gimbal_motor_absolute_angle_pid, YAW_ABSOLUTE_ANGLE_AUTO_KP, YAW_ABSOLUTE_ANGLE_AUTO_KI, YAW_ABSOLUTE_ANGLE_AUTO_KD, YAW_ABSOLUTE_ANGLE_AUTO_MAX_OUT, YAW_ABSOLUTE_ANGLE_AUTO_MAX_IOUT); //锟斤拷锟斤拷锟角角度匡拷锟斤拷
